...
function MagneticBtn({ href, children }: { href: string; children: React.ReactNode }) {
  ...
  return (
    <motion.a
      ref={ref}
      href={href}
      style={{ x: sx, y: sy, fontFamily: "var(--font)" }}
      onMouseMove={onMove}
      onMouseLeave={() => { x.set(0); y.set(0); }}
      className="group inline-flex items-center gap-3 text-sm font-medium"
    >
      <motion.span
        className="w-12 h-12 rounded-full flex items-center justify-center text-sm transition-colors duration-300"
...
export default function Contact() {
  ...
  // Split headline into 2 lines at a natural midpoint
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-[3fr_2fr] gap-16 md:gap-24 items-end">
          ...
          >
            ...
            <MagneticBtn href={`mailto:${t.contact.email}`}>
              {t.contact.cta}
            </MagneticBtn>
